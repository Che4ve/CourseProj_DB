...
Для повышения производительности созданы индексы на полях, используемых в фильтрации и сортировке. В таблице \ref{tab:perf} приведено сравнение времени выполнения запросов до и после индексирования. Полные планы EXPLAIN ANALYZE приведены в приложении В.
...
\newpage
\section*{ПРИЛОЖЕНИЕ В Результаты EXPLAIN ANALYZE}
\addcontentsline{toc}{section}{ПРИЛОЖЕНИЕ В Результаты EXPLAIN ANALYZE}
